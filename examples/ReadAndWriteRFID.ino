...
#define RFID_CS    9    // 片选引脚
#define RFID_RST   5    // 复位引脚
#define RFID_SCK   6    // 软件SPI时钟引脚
#define RFID_MOSI  4    // 软件SPI数据输出引脚
#define RFID_MISO  3    // 软件SPI数据输入引脚

RFID rfid(RFID_CS, RFID_RST, RFID_SCK, RFID_MOSI, RFID_MISO); 
